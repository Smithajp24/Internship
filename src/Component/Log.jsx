...
<MDBRow>
  ...
  <MDBCol col='4' md='6'>
    ...
    <MDBInput wrapperClass='mb-4'  onChange={HandleChange} name="email" label='Email address' id='formControlLg' type='email' size="lg"/>
    <MDBInput wrapperClass='mb-4' onChange={HandleChange} name="password" label='Password' id='formControlLg' type='password' size="lg"/>
